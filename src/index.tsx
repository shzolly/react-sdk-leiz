  ...
  render(
    <BrowserRouter>
      <Switch>
        ...
        <Route path={`${baseURL}designsystem`} component={DesignSystem} />
        <Route path={`${baseURL}designsystem.html`} component={DesignSystem} />
        <Route path={`${baseURL}landingpage`} component={LandingPage} />
        <Route path={`${baseURL}landingpage.html`} component={LandingPage} />
        <Route path={`${baseURL}component`} component={Component} />
