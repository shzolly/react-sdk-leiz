...
import NjjLeizComponentLibTicketEntry from './index';
...
const meta: Meta<typeof NjjLeizComponentLibTicketEntry> = {
  title: 'NjjLeizComponentLibTicketEntry',
  component: NjjLeizComponentLibTicketEntry,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof NjjLeizComponentLibTicketEntry>;
...
export const BaseNjjLeizComponentLibTicketEntry: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <NjjLeizComponentLibTicketEntry {...props} {...args}>
        {regionAChildren}
      </NjjLeizComponentLibTicketEntry>
    </>
  );
};

BaseNjjLeizComponentLibTicketEntry.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1
