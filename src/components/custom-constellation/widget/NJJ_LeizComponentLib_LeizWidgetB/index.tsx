...
import StyledNjjLeizComponentLibLeizWidgetBWrapper from './styles';
...
// interface for props
interface NjjLeizComponentLibLeizWidgetBProps extends PConnFieldProps {
...
function NjjLeizComponentLibLeizWidgetB(props: NjjLeizComponentLibLeizWidgetBProps) {
  ...
  return (
    <StyledNjjLeizComponentLibLeizWidgetBWrapper>
      <Table
...
export default withConfiguration(NjjLeizComponentLibLeizWidgetB);
