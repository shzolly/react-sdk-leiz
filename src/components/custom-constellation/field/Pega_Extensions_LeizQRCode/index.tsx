...
import { withConfiguration, Flex, FormControl, FormField, QRCode, FieldValueList, Text } from '@pega/cosmos-react-core';
...
export const PegaExtensionsQRCode = (props: QRCodeCompProps) => {
  const { inputProperty, label, value, validatemessage, hideLabel = false, readOnly, helperText, testId, displayMode, variant, getPConnect } = props;
