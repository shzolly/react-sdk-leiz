...
interface NjjLeizComponentLibLeizWidgetAProps extends PConnProps {
...
export default function NjjLeizComponentLibLeizWidgetA(props: NjjLeizComponentLibLeizWidgetAProps) {
