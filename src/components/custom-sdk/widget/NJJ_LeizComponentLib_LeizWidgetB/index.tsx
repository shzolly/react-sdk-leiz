...
interface NjjLeizComponentLibLeizWidgetBProps extends PConnProps {
...
export default function NjjLeizComponentLibLeizWidgetB(props: NjjLeizComponentLibLeizWidgetBProps) {
