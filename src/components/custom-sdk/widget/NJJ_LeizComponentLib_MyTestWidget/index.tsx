...
interface NjjLeizComponentLibMyTestWidgetProps extends PConnProps {
...
export default function NjjLeizComponentLibMyTestWidget(props: NjjLeizComponentLibMyTestWidgetProps) {
