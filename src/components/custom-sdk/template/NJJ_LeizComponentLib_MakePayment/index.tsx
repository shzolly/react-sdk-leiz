...
interface NjjLeizComponentLibMakePaymentProps extends PConnProps {
...
export default function NjjLeizComponentLibMakePayment(props: NjjLeizComponentLibMakePaymentProps) {
