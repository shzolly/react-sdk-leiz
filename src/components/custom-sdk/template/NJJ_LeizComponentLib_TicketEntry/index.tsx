...
interface NjjLeizComponentLibTicketEntryProps extends PConnProps {
...
export default function NjjLeizComponentLibTicketEntry(props: PropsWithChildren<NjjLeizComponentLibTicketEntryProps>) {
