...
export default function Home() {
  ...
  useEffect(() => {
    if (isPegaReady) {
      ...
      setShowPega('Pega');
      console.log('Home-IsPegaReady', isPegaReady);
    }
  }, [isPegaReady]);

  async function handleLinkToGithub() {
    window.open('https://github.com/AOC-ITO/NJMC-Pega/tree/main/react-sdk-lab', '_blank');
  }
        ...
        <section className='bg-white dark:bg-gray-900'>
          <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12'>
            ...
            >
              ...
              <span className='text-sm font-medium'>System outage on Sunday, March 2, 2025, from 6:00 AM - 11:00 AM.</span>
            ...
            <h1 className='mb-4 text-3xl lg:text-4xl font-bold lg:font-extrabold lg:tracking-tight  tracking-tighter leading-none text-gray-900 dark:text-white'>
              Welcome to the Lab for Constellation SDK!
            </h1>
            ...
            <div className='flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4'>
              <Button variant='default' onClick={handleLinkToGithub}>
